...
export function renderPaymentSummary(){
    ...
    const totalPrice = shippingPriceCents+productPriceCents;
    const totalTax = totalPrice*0.1;

    console.log(productPriceCents, finalQuantity);
    ...
    paymentSummaryHTML += `
            ...
            <div class="payment-summary-row total-row">
                <div>Order total:</div>
                <div class="payment-summary-money">$${formatCurrency(totalPrice+totalTax)}</div>
            </div>
    ...
    document.querySelector('.js-order-btn').addEventListener('click', async() => {
        try{
